  ...
  <div class="container px-5 my-5">
    <form method="POST">
        <div class="mb-3">
            ...
            <input class="form-control" name="nama" id="nama" type="text" placeholder="Nama Pegawai" data-sb-validations="required" />
        ...
        <div class="mb-3">
            ...
            <input class="form-control" name="anak" id="anak" type="text" placeholder="Jumlah Anak" data-sb-validations="required" />
            <div class="invalid-feedback" data-sb-feedback="anak:required">Jumlah Anak is required.</div>
        </div>
    ...
    if (isset($_POST['simpan'])) {
        ...
        $zakat = ($agama == "Islam" && $gakor >= 6000000) ? (2.5 * $gakor) / 100 : 0 ;
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Rincian Gaji</h5>
      ...
      <div class="modal-body">
        <table>
            ...
            <tr>
                <td>Gaji Kotor</td>
                <td>&nbsp;:&nbsp;</td>
                <td><?="Rp. ".number_format($gakor, 2, ',', '.')?></td>
            </tr>
            <tr>
                <td>Zakat Profesi</td>
                <td>&nbsp;:&nbsp;</td>
